...
if jmeno in prihlasovaci_udaje.keys() and prihlasovaci_udaje[jmeno] == heslo:
    ...
    if vyber >= 4:
        print("Možnost není v zadání")        
    else:
        print(oddelovac)
        slova_rozdelena = TEXTS[vyber-1].split()
        ...
        print("There are ",pocet_zacinajici_velka, "titlecase words")
        print("There are ",pocet_velka_pismena, "uppercase words")
        print("There are ",pocet_mala_pismena, "lowercase words")
        print("There are ",pocet_cislic, "numeric strings")
        print("The sum of all numbers", cislice)
        print(oddelovac)
